...
const allPrograms = [
  {
    ...
    subjects: ["Matematika", "Ingliz tili", "Rus Tili", "IT"],
  ...
  },
  {
    ...
    subjects: ["Matematika", "Ingliz tili", "Kimyo", "Biologiya"],
  ...
  },
  {
    ...
    subjects: ["SAT/IELTS", "Iqtisod", "Kimyo", "Biologiya"],
      ...
      <section className="page-hero">
        <div className="container page-hero-content">
          <div className="section-tag">
            <BookOpen size={14} /> Dasturlar
          </div>
          <h1 className="page-hero-title">O'quv Yo'nalishlari</h1>
          <p className="page-hero-desc">
            Har yosh va qiziqishga mos dastur. Farzandingiz kelajagi uchun
        ...
        <div className="container">
          <div className="programs-full-grid">
            {allPrograms.map((prog, i) => (
              <div
                key={i}
                className={`prog-full-card ${prog.featured ? "featured" : ""}`}
              >
                {prog.featured && (
                  <div className="featured-ribbon">Eng Mashhur</div>
                )}
